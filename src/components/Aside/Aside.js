        ...
        <div className='col-lg-3 col-md-5 col-sm-12 bg-dark'>
            ...
            <div className='p-2 justify-content-center'>
                ...
                <div className="row bg-warning gap-2 p-3 py-4 rounded-3 break mx-0 ps-4">
                    <div className="col-2 rounded-3 text-center p-0"><button onClick={()=> addBreakTime(10)} className='btns btn btn-dark fw-bolder'>10s</button></div>
                    <div className="col-2 rounded-3 text-center p-0"><button onClick={()=> addBreakTime(15)} className='btns btn btn-dark fw-bolder'>15s</button></div>
                    <div className="col-2 rounded-3 text-center p-0"><button onClick={()=> addBreakTime(20)} className='btns btn btn-dark fw-bolder'>20s</button></div>
                    <div className="col-2 rounded-3 text-center p-0"><button onClick={()=> addBreakTime(25)} className='btns btn btn-dark fw-bolder'>25s</button></div>
                    <div className="col-2 rounded-3 text-center p-0"><button onClick={()=> addBreakTime(30)} className='btns btn btn-dark fw-bolder'>30s</button></div>
                </div>
            </div>
            ...
            <div className='p-2'>
                ...
                <div className="row bg-warning rounded-3 break mx-0 mt-4">
                    ...
                    <div className="col-5 times"><p className='text-muted'><span id='break-time'>{breakTime}</span> seconds</p></div>
                </div>
            </div>
